<div>
    ...
    <table class="table">
        ...
        $sql = "SELECT * FROM food_schedule_diabetes";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td><button class="btn btn-primary" style="height:40px" onclick="editFSDiabetes('<?= $row['id'] ?>')">Edit</button></td>
                    <td><button class="btn btn-danger" style="height:40px" onclick="deleteFSDiabetes('<?= $row['id'] ?>')">Delete</button></td>
                </tr>
                <?php
                $count = $count + 1;
            }
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" onsubmit="addFSDiabetes()" method="POST">
