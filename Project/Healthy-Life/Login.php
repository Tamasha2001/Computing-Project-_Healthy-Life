...
if (isset($_SESSION["user_id"])) {
  header("Location: http://localhost:81/Healthy-life/index.php");
}
...
if (isset($_POST["signin"])) {
  ...
  if (mysqli_num_rows($check_email) > 0) {
    ...
    header("Location: http://localhost:81/Healthy-life/UserForm.php");
  ...
  <div class="container">
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        ...
        <img src="Images/svg/Signup.svg" class="image" alt="" />
      </div>
