...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($_POST['categoryId'])) {
    ...
    // Call the function to fetch and display filtered products
...
<html>
  ...
  <head>
    <title> Explore | Food Healthy Life </title>
  </head>
...
?>
    ...
    <div class="carousel-inner">
      ...
      <img src="images/slider1.jpg" style="width:100%; height:400px;">
      ...
      <div class="item">
      <img src="images/slider3.jpg" style="width:100%; height:400px;">
      <div class="carousel-caption">
      </div>
      </div>
...
<div class="jumbotron">
  <div class="container text-center">
    <h1>Welcome To Healthy Life Food Store</h1>      
...
<!-- <div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="#">Cholesterole</a>
  </div>
</div>
<br> -->
<div class="filter-dropdown" style="width:20%;">
<label for="categoryDropdown" >Select a Category:</label>
  <select class="form-control" id="categoryDropdown">
    ...
    <option value="5">Hemoglobin</option>
    <option value="6">Gym</option>
    <option value="7">Overweight</option>
    <option value="8">Underweight</option>
  </select>
</div>
  <br>
  <!-- Container to display filtered products -->
  <div id="filteredProductsContainer"></div>
  </div>
  ...
  <script> 
    $('#categoryDropdown').on('change', function() {
      ...
      $.ajax({
        ...
        error: function() {
          $('#filteredProductsContainer').html('Error occurred while fetching products.');
        }
      });
    });
